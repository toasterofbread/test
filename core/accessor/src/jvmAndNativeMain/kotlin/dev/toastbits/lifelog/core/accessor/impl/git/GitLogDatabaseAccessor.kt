...
//    }
//
//    override suspend fun loadDatabaseLocally(onAlert: (ParseAlertData) -> Unit): LogDatabaseData {
...
//        remote != null
//
//    override suspend fun loadDatabaseRemotely(onAlert: (ParseAlertData) -> Unit): LogDatabaseData {
//        checkNotNull(remote)
//        syncRepository()
